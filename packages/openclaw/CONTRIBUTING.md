...
[contributing guidelines]: https://github.com/opendatahub-io/odh-dashboard/blob/main/CONTRIBUTING.md
...
For an in-depth guide on how to deploy the Openclaw UI, please refer to the [local kubernetes deployment](./docs/local-deployment-guide.md) documentation.

To quickly enable the Openclaw UI in your Kind cluster, you can use the following command:
